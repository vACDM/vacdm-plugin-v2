...
namespace vacdm::utils
{
  ...
  private:
    ...
    static auto splitAux(const std::string &value, Separator &&separator)
  ...
  public:
     ...
     * @return
     */
    static __inline void stringReplace(std::string &message,
     ...
     */
    static auto splitString(const std::string &value,
                            const std::string &separators)
        -> std::vector<std::string>
    {
      return String::splitAux(
          value, [&](const std::string &v, std::string::size_type p) noexcept
     ...
     */
    static auto trim(const std::string &value, const std::string &spaces = " \t")
        -> std::string
    {
